      ...
      <div class="navbar flex-center position-ref full-height float-right" style="font-size:20px;">
            @if (Route::has('login'))
                ...
                <a class="js-scroll-trigger" href="#contact">Kontakt</a>
                    &nbsp;
                    <a class="js-scroll-trigger" href="vizija.pdf">Vizija</a>
                &nbsp;
                    @auth
        ...
        <div class="col-lg-12">
          <form id="contactForm" name="sentMessage" novalidate="novalidate">
            <div class="row">
              ...
              <div class="col-lg-12 text-center">
                <div id="success"></div>
                <button id="sendMessageButton" class="btn btn-primary btn-xl text-uppercase" type="submit">Pošaljite poruku</button>
              </div>
            </div>
          </form>
        </div>
